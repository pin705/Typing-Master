...
<template>
  <div class="container mx-auto px-4 py-12 max-w-4xl text-center">
    <h1 class="text-3xl font-bold text-gray-900 mb-8">Typing Speed Test</h1>
    
    <div class="bg-white p-12 rounded-xl shadow-sm border border-gray-100">
      <div v-if="!isTesting && result === null">
        <p class="text-gray-600 mb-8 text-lg">Test your typing speed with our quick 1-minute test.</p>
        <button 
      ...
      <div v-else-if="isTesting">
        <p class="text-gray-600 mb-4 font-medium">Testing your speed...</p>
      ...
      <div v-else class="animate-fade-in">
        ...
        <p class="text-gray-600 mb-8">Great job! Keep practicing to improve your speed.</p>
        <button 
