...
<template>
  <div class="flex flex-col gap-6">
    ...
    <div class="flex flex-wrap items-center justify-center gap-4">
      ...
      <!-- Article Selection -->
      <div class="flex items-center gap-2 bg-white rounded-lg shadow-sm p-2 border border-gray-100">
        <span class="i-heroicons-document-text text-gray-500 ml-2" />
        <select
        ...
        >
          ...
          <option value="random">
            🎲 {{ t('controls.random_article') }}
          </option>
          <option value="custom">
            ✏️ {{ t('controls.custom_text') }}
          </option>
        </select>
      </div>
    </div>
    ...
    <div class="flex flex-wrap items-center justify-center gap-3">
      ...
      >
        <span class="i-heroicons-moon text-lg" />
      ...
      >
        <span class="i-heroicons-eye text-lg" />
      ...
      >
        <span class="i-heroicons-arrows-pointing-out text-lg" />
      ...
      >
        <span class="i-heroicons-speaker-wave text-lg" />
